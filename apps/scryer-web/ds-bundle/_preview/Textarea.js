...
var __dsPreview = (() => {
  ...
  function States() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-3 p-6 max-w-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Textarea, { placeholder: "Release notes…" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Textarea, { defaultValue: "Block releases over 100 GiB\nReject x265 unless 2160p" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Textarea, { placeholder: "Disabled", disabled: true })
    ] });
  }
  function WithLabel() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-2 p-6 max-w-sm", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Label, { htmlFor: "custom-script", children: "Custom post-processing script" }),
