...
const en: LocaleDictionary = {
  ...
  "settings.externalAccountInviteRequired": "Choose a user, provider, connection, provider user ID, and username.",
  ...
  "settings.providerUsername": "Provider username",
  "settings.providerExternalUserId": "Provider user ID",
