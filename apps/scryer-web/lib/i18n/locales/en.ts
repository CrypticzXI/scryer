...
const en: LocaleDictionary = {
  ...
  "settings.authProvidersDescription":
    "Choose which external providers can link accounts or sign in, then allow the exact media-server connection IDs Scryer should trust.",
  ...
  "settings.externalAccountInvitesUnavailable":
    "Enable provider login and allow at least one provider connection before creating external account invites.",
