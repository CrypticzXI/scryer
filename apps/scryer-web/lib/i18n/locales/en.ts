...
const en: LocaleDictionary = {
  ...
  "search.globalPlaceholder": "Search movies, series, anime, and settings…",
  "search.globalPlaceholderNoLibrary": "Search movies, series, anime, settings, and actions…",
  "search.overlayPlaceholder": "Search movies, series, anime, your library, and navigation…",
  "search.overlayPlaceholderNoLibrary": "Search movies, series, anime, settings, and actions…",
  "search.shortcutHint": "⌘K",
  "search.shortcutHintControl": "Ctrl+K",
  "search.title": "Global Search",
  "search.subtitle": "Search movies, series, anime, your library, and navigation.",
  "search.subtitleNoLibrary": "Search movies, series, anime, settings, and actions.",
  ...
  "search.tipTitles": "Search by movie, series, or anime title, catalog, settings section, or action name.",
  "search.tipTitlesNoLibrary": "Search by movie, series, or anime title, settings section, or action name.",
  "search.tipTabs": "Use tabs to narrow results to your library, navigation, or one catalog type.",
  "search.tipTabsNoLibrary": "Use tabs to narrow results to navigation or one catalog type.",
  "search.tipIndexers": "Use a broader term before checking indexers for titles not in metadata results.",
  "search.noMatchesFor": "No matches for “{{query}}”",
  "search.emptyHint": "Try another movie, series, anime, catalog name, settings section, or action.",
  "search.emptyHintNoLibrary": "Try another movie, series, anime, settings section, or action.",
  "search.minimumQueryTitle": "Keep typing",
  "search.minimumQueryHint": "Type at least 2 characters to search your library and metadata.",
  "search.minimumQueryHintNoLibrary": "Type at least 2 characters to search metadata.",
