...
const it: LocaleDictionary = {
  ...
  "dashboard.resolveImport": "Risolvi",
  "dashboard.upgradeBadge": "Upgrade",
  "dashboard.reasonUnmatched": "Non abbinato",
  "dashboard.reasonAmbiguous": "Ambiguo",
  "dashboard.reasonQualityUnknown": "Qualità sconosciuta",
  "dashboard.reasonOther": "Da verificare",
  ...
  "settings.pluginAutoUpdateEnabledHelp":
    "Se attivo, aggiorna automaticamente i plugin all’ultima versione patch pubblicata, ad es. 1.0.1 => 1.0.2. Le versioni minor e major restano a carico dell’operatore.",
