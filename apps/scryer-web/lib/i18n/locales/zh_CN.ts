...
const zh_CN: LocaleDictionary = {
  ...
  "search.globalPlaceholder": "找到你接下来想看的内容（按 / 键）",
  "search.catalog": "目录",
  ...
  "subtitle.blacklist": "阻止列表",
  "subtitle.blacklisted": "字幕已添加到阻止列表",
