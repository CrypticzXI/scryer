...
const ko: LocaleDictionary = {
  ...
  "search.globalPlaceholder": "다음에 볼 작품을 찾아보세요 (/ 키를 누르세요)",
  "search.catalog": "카탈로그",
