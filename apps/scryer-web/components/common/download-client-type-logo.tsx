...
const DOWNLOAD_CLIENT_TYPE_OPTIONS: DownloadClientTypeOption[] = [
  { value: "nzbget", icon: NzbgetIcon },
  { value: "sabnzbd", icon: SabnzbdIcon },
  { value: "weaver", iconSrc: "/download-clients/weaver.webp", icon: WeaverIcon },
  { value: "qbittorrent", icon: QBitTorrentIcon },
];
