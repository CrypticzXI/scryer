...
use scryer_application::{
    ...
    RECYCLE_BIN_ENABLED_KEY, RENAME_COLLISION_POLICY_GLOBAL_KEY, RENAME_COLLISION_POLICY_KEY,
...
pub(crate) fn service_setting_seeds() -> &'static [ServiceSettingSeed] {
    &[
        ...
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: TOTP_REQUIRE_CONFIG_STEP_UP_KEY,
            data_type: "boolean",
            default_value_json: "false",
            is_sensitive: false,
        },
        ...
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_ALLOWED_PROVIDERS_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_PROVIDER_LOGIN_ENABLED_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_PROVIDER_LINKING_ENABLED_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_ALLOWED_JELLYFIN_CONNECTION_IDS_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_JELLYFIN_CONNECTIONS_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_ALLOWED_PLEX_CONNECTION_IDS_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
        ServiceSettingSeed {
            category: SETTINGS_CATEGORY_SECURITY,
            scope: SETTINGS_SCOPE_SYSTEM,
            key_name: AUTH_PLEX_CONNECTIONS_KEY,
            data_type: "json",
            default_value_json: "[]",
            is_sensitive: false,
        },
