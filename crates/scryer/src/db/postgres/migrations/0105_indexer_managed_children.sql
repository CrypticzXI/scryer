ALTER TABLE indexers ADD COLUMN IF NOT EXISTS managed_parent_config_id TEXT;
ALTER TABLE indexers ADD COLUMN IF NOT EXISTS managed_child_key TEXT;
ALTER TABLE indexers ADD COLUMN IF NOT EXISTS managed_metadata_json JSONB;
