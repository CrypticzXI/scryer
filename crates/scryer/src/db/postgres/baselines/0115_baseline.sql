...
CREATE TABLE collections (
    ...
    interstitial_genres_json jsonb,
    ...
    special_movies_json jsonb DEFAULT '[]'::jsonb NOT NULL
);
...
CREATE INDEX idx_download_jobs_client ON download_jobs USING btree (download_client_id, status);
CREATE INDEX idx_download_jobs_workflow ON download_jobs USING btree (workflow_operation_id);
...
CREATE INDEX idx_integration_tokens_user ON integration_tokens USING btree (user_id);
