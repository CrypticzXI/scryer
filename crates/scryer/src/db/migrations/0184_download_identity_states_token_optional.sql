...
CREATE TABLE download_identity_states_0184 (
    id TEXT PRIMARY KEY,
...
INSERT INTO download_identity_states_0184 (
    id,
    identity_key,
...
ALTER TABLE download_identity_states_0184 RENAME TO download_identity_states;
