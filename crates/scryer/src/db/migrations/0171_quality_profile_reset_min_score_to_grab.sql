...
UPDATE quality_profiles
   SET scoring_config = json_remove(scoring_config, '$.min_score_to_grab')
 WHERE json_valid(scoring_config)
   AND json_extract(scoring_config, '$.min_score_to_grab') IS NOT NULL;
