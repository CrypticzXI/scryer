...
ALTER TABLE wanted_items DROP COLUMN search_phase;
ALTER TABLE wanted_items DROP COLUMN next_search_at;
ALTER TABLE wanted_items DROP COLUMN search_count;
ALTER TABLE wanted_items DROP COLUMN baseline_date;
