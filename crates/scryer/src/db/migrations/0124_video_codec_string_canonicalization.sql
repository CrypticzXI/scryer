...
SET analysis_json = json_set(
    ...
    '$.video_codec',
    CASE
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('AVC', 'AVC1', 'H264', 'X264') THEN 'H.264'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('HEVC', 'HEV1', 'H265', 'HVC1', 'X265') THEN 'H.265'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('AV1', 'AV01') THEN 'AV1'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'VP9' THEN 'VP9'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'VC1' THEN 'VC1'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'MPEG2' THEN 'MPEG2'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('MPEG4', 'MP4V') THEN 'MPEG4'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'XVID' THEN 'XVID'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'DIVX' THEN 'DIVX'
        WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(json_extract(analysis_json, '$.video_codec'))), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('VVC', 'H266') THEN 'VVC'
        ELSE json_extract(analysis_json, '$.video_codec')
    END
)
WHERE analysis_json IS NOT NULL
  AND json_valid(analysis_json)
  AND json_type(analysis_json, '$.video_codec') = 'text';

CREATE TEMP TABLE quality_profile_video_codec_allowlist_norm (
    profile_id TEXT NOT NULL,
    codec TEXT NOT NULL,
    created_at TEXT NOT NULL
);

INSERT INTO quality_profile_video_codec_allowlist_norm (profile_id, codec, created_at)
SELECT
    profile_id,
...
FROM (
    SELECT
        ...
        created_at,
        CASE
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('AVC', 'AVC1', 'H264', 'X264') THEN 'H.264'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('HEVC', 'HEV1', 'H265', 'HVC1', 'X265') THEN 'H.265'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('AV1', 'AV01') THEN 'AV1'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'VP9' THEN 'VP9'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'VC1' THEN 'VC1'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'MPEG2' THEN 'MPEG2'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('MPEG4', 'MP4V') THEN 'MPEG4'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'XVID' THEN 'XVID'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') = 'DIVX' THEN 'DIVX'
            WHEN REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(TRIM(codec)), '.', ''), '-', ''), '_', ''), ' ', ''), '/', '') IN ('VVC', 'H266') THEN 'VVC'
            ELSE codec
...
CREATE TEMP TABLE quality_profile_video_codec_blocklist_norm (
    profile_id TEXT NOT NULL,
    codec TEXT NOT NULL,
    created_at TEXT NOT NULL
);

INSERT INTO quality_profile_video_codec_blocklist_norm (profile_id, codec, created_at)
SELECT
    profile_id,
    canonical_codec AS codec,
    MIN(created_at) AS created_at
