...
pub(crate) async fn replace_title_metadata_tags_tx(
    tx: &mut SqlTx<'_>,
    title_id: &str,
...
pub(crate) async fn replace_discovery_title_metadata_tags_tx(
    tx: &mut SqlTx<'_>,
...
pub(crate) async fn attach_metadata_tags_to_titles(
    exec: SqlExec<'_, '_>,
    titles: &mut [Title],
) -> AppResult<()> {
    if titles.is_empty() {
...
pub(crate) async fn load_title_metadata_tags(
    exec: SqlExec<'_, '_>,
    title_ids: &[String],
...
pub(crate) async fn load_discovery_title_metadata_tags(
    exec: SqlExec<'_, '_>,
...
pub(crate) async fn replace_title_metadata_ratings_tx(
    tx: &mut SqlTx<'_>,
    title_id: &str,
...
pub(crate) async fn replace_discovery_title_metadata_ratings_tx(
    tx: &mut SqlTx<'_>,
    discovery_title_id: &str,
    ratings: &TitleRatingSummary,
) -> AppResult<()> {
...
pub(crate) async fn load_title_metadata_ratings(
    exec: SqlExec<'_, '_>,
    title_ids: &[String],
...
pub(crate) async fn load_discovery_title_metadata_ratings(
    exec: SqlExec<'_, '_>,
    discovery_title_ids: &[String],
) -> AppResult<BTreeMap<String, TitleRatingSummary>> {
